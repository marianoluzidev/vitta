<template>
  <f7-page name="control-panel-login">
    <f7-navbar title="Panel de Control" />
...
const handleEmailSignIn = async () => {
  ...
  errorMessage.value = '';
  try {
    console.log('Email sign in clicked', { email: email.value, password: '***' });
...
const redirectAfterLogin = () => {
  ...
  if (redirect) {
    ...
    // Por defecto, redirigir al panel de control
    targetPath = '/controlPanel/';
  }
...
onMounted(async () => {
  console.log('Control panel login page mounted');
